...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/Users/marcus/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  harpoon = {
    loaded = true,
    path = "/Users/marcus/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["prettier.nvim"] = {
    loaded = true,
    path = "/Users/marcus/.local/share/nvim/site/pack/packer/start/prettier.nvim",
